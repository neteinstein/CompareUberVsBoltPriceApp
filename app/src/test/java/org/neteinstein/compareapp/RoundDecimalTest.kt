...
class RoundDecimalTest {
    ...
    fun testRoundDecimal_withDefaultScale() {
        ...
        // When
        val result = MathUtils.roundDecimal(value)
    ...
    fun testRoundDecimal_withCustomScale() {
        ...
        // When
        val result = MathUtils.roundDecimal(value, 6)
    ...
    fun testRoundDecimal_withLowerScale() {
        ...
        // When
        val result = MathUtils.roundDecimal(value, 2)
    ...
    fun testRoundDecimal_withZeroScale() {
        ...
        // When
        val result = MathUtils.roundDecimal(value, 0)
